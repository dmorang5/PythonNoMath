...
dataRuta=r'D:\UDEMY\Python para no matematicos De 0 hasta reconocimiento facial\Reconocimiento facial\Data'
listaData = [d for d in os.listdir(dataRuta) if os.path.isdir(os.path.join(dataRuta, d))]
